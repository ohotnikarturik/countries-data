...
for (let country of countries) {
  ...
  let countryAlphaCode = document.createElement('h5');
  let countryCallCode = document.createElement('h5');
  let countryCapital = document.createElement('h5');
  let countryRegion = document.createElement('h5');
  let countryPopulation = document.createElement('h5');
  let countryArea = document.createElement('h5');
  let countryFlag = document.createElement('img');

  let liItem = document.createElement('li');

  liItem.setAttribute('class', 'item');
  countryName.setAttribute('class', 'elem elem_name');
  countryAlphaCode.setAttribute('class', 'elem elem_alphaCode');
  countryCallCode.setAttribute('class', 'elem elem_call');
  countryCapital.setAttribute('class', 'elem elem_capital');
  countryRegion.setAttribute('class', 'elem elem_region');
  countryPopulation.setAttribute('class', 'elem elem_population');
  countryArea.setAttribute('class', 'elem elem_area');
  countryFlag.setAttribute('class', 'elem elem_flag');
  span.setAttribute('class', 'span1');
  span1.setAttribute('class', 'span');
  span2.setAttribute('class', 'span1');
  span3.setAttribute('class', 'span');
  span4.setAttribute('class', 'span1');
  span5.setAttribute('class', 'span');
  span6.setAttribute('class', 'span1');
  span7.setAttribute('class', 'span');
  span8.setAttribute('class', 'span1');
  span9.setAttribute('class', 'span');
  span10.setAttribute('class', 'span1');
  span11.setAttribute('class', 'span');
  span12.setAttribute('class', 'span1');
  countryFlag.setAttribute('src', `${flag}`);

  liItem.appendChild(countryName).textContent = name;

  liItem.appendChild(countryAlphaCode);
  countryAlphaCode.appendChild(span1).textContent = 'Code name: ';
  countryAlphaCode.appendChild(span2).textContent = alpha2Code;

  liItem.appendChild(countryCallCode);
  countryCallCode.appendChild(span3).textContent = 'Code phone: ';
  countryCallCode.appendChild(span4).textContent = callingCodes;

  liItem.appendChild(countryCapital);
  countryCapital.appendChild(span5).textContent = 'Capital: ';
  countryCapital.appendChild(span6).textContent = capital;

  liItem.appendChild(countryRegion);
  countryRegion.appendChild(span7).textContent = 'Region: ';
  countryRegion.appendChild(span8).textContent = region;

  liItem.appendChild(countryPopulation);
  countryPopulation.appendChild(span9).textContent = 'Population: ';
  countryPopulation.appendChild(span10).textContent = population;

  liItem.appendChild(countryArea);
  countryArea.appendChild(span11).textContent = 'Area: ';
  countryArea.appendChild(span12).textContent = area;

  liItem.appendChild(countryFlag);
